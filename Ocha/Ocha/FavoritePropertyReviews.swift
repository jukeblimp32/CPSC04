...
class FavoritePropertyReviews: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "backToFavorite",
        ...
        if segue.identifier == "createFavoriteReview",
            let destination = segue.destination as? FavoriteCreateReview
