...
class ManageListings: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        toHomePageButton.addTarget(self, action: #selector(ManageListings.logout(_:)), for: UIControlEvents.touchUpInside)
